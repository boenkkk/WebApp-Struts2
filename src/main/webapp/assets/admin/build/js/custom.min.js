...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        $("#chart_plot_01").length && (console.log(), $.plot($("#chart_plot_01"), [a, b], g)), $("#chart_plot_02").length && (console.log(), $.plot($("#chart_plot_02"), [{
            label: "Email Sent",
            data: d,
            lines: {
        ...
        }], h)), $("#chart_plot_03").length && (console.log(), $.plot($("#chart_plot_03"), [{
            label: "Registrations",
            data: e,
            lines: {
                fillColor: "rgba(150, 202, 89, 0.12)"
...
function init_starrr() {
    ...
    "undefined" != typeof starrr && (console.log(), $(".stars").starrr(), $(".stars-existing").starrr({
        rating: 4
...
function init_JQVmap() {
    ...
    "undefined" != typeof jQuery.fn.vectorMap && (console.log(), $("#world-map-gdp").length && $("#world-map-gdp").vectorMap({
        map: "world_en",
...
function init_chart_doughnut() {
    ...
    if ("undefined" != typeof Chart && (console.log(), $(".canvasDoughnut").length)) {
        var a = {
            type: "doughnut",
...
function init_sparklines() {
    ...
    "undefined" != typeof jQuery.fn.sparkline && (console.log(), $(".sparkline_one").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5, 4, 5, 4, 5, 4, 3, 4, 5, 6, 7, 5, 4, 3, 5, 6], {
        type: "bar",
        height: "125",
        barWidth: 13,
        colorMap: {
...
function init_parsley() {
    if ("undefined" != typeof parsley) {
        ...
        console.log(), $("parsley:field:validate", function() {
            a()
...
function init_select2() {
    ...
    "undefined" != typeof select2 && (console.log(), $(".select2_single").select2({
...
function init_wysiwyg() {
    function b(a, b) {
        ...
        "unsupported-file-type" === a ? c = "Unsupported format " + b : console.log(), $('<div class="alert"> <button type="button" class="close" data-dismiss="alert">&times;</button><strong>File upload error</strong> ' + c + " </div>").prependTo("#alerts")
    }
    //"undefined" != typeof $.fn.wysiwyg && (console.log("init_wysiwyg"), $(".editor-wrapper").each(function() {
    "undefined" != typeof $.fn.wysiwyg && (console.log(), $(".editor-wrapper").each(function() {
        var a = $(this).attr("id");
        $(this).wysiwyg({
...
function init_daterangepicker_single_call() {
    ...
    "undefined" != typeof $.fn.daterangepicker && (console.log(), $("#single_cal1").daterangepicker({
        singleDatePicker: !0,
...
function init_daterangepicker_reservation() {
    ...
    "undefined" != typeof $.fn.daterangepicker && (console.log(), $("#reservation").daterangepicker(null, function(a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
...
function init_CustomNotification() {
    ...
    if (console.log(), "undefined" != typeof CustomTabs) {
...
function init_charts() {
    ...
    if (console.log(), "undefined" != typeof Chart) {
        //if (console.log("init_charts"), Chart.defaults.global.legend = {
        if (console.log(), Chart.defaults.global.legend = {
                enabled: !1
            }, $("#canvas_line").length) {
...
function init_compose() {
    ...
    "undefined" != typeof $.fn.slideToggle && (console.log(), $("#compose, .compose-close").click(function() {
        $(".compose").slideToggle()
    }))
}
...
function init_DataTables() {
    ...
    if (console.log(), "undefined" != typeof $.fn.DataTable) {
